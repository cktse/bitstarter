...
var checkDoc = function(checksfile) {
...
if(require.main == module) {
    program
        ...
        .parse(process.argv);
    var checkJson = {};
	//console.log("file="+program.file+", url="+program.url);
	if (program.url != null) {
		checkUrl(program.url, program.checks);
	} else if (program.file != null) {
		checkJson = checkHtmlFile(program.file, program.checks);
	} else {
		console.log(__filename + ": requires either file or url"); // TODO: clean up command default
	}
} else {
